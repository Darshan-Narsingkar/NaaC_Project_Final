...
<div class="container mt-5">
    <h2 class="text-center">Research Awards Submission</h2>
    <form action="research_awards_submit.php" method="POST" enctype="multipart/form-data" class="p-4 border rounded bg-light">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <label for="award_organization" class="form-label">Award Organization:</label>
