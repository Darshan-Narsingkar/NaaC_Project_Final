...
$sql = "SELECT id, academic_year, faculty_name, publication_type, title, publisher_name, ISBN_number FROM book_chapter_publications WHERE department = 'civil'";
...
$pdf->Cell(0, 10, 'Book Chapter Publications (CIVIL Department)', 0, 1, 'C');
