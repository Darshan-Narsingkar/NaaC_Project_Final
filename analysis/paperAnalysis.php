...
$query = "SELECT department, status, COUNT(*) as count FROM  research_papers GROUP BY department, status";
...
<head>
    ...
    <title> research_papers Analysis</title>
...
<body>
    <h2> research_papers Analysis by Department</h2>
    ...
    ?>
        ...
        new Chart(ctxBar, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?>  research_papers Count',
                    data: counts,
        ...
        new Chart(ctxPie, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?>  research_papers Distribution',
                    data: counts,
