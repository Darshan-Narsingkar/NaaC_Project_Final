...
$query = "SELECT department, status, COUNT(*) as count FROM research_awards GROUP BY department, status";
...
<head>
    ...
    <title>research_awards Analysis</title>
...
<body>
    <h2>research_awards Analysis by Department</h2>
    ...
    ?>
        ...
        new Chart(ctxBar, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> research_awards Count',
                    data: counts,
        ...
        new Chart(ctxPie, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> research_awards Distribution',
                    data: counts,
