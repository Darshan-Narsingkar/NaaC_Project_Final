...
$query = "SELECT department, status, COUNT(*) as count FROM book_chapter_publications GROUP BY department, status";
...
<head>
    ...
    <title>book_chapter_publications Analysis</title>
...
<body>
    <h2>book_chapter_publications Analysis by Department</h2>
    ...
    ?>
        ...
        new Chart(ctxBar, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> book_chapter_publications Count',
                    data: counts,
        ...
        new Chart(ctxPie, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> book_chapter_publications Distribution',
                    data: counts,
