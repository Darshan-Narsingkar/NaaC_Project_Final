...
$query = "SELECT * FROM faculty WHERE department = 'civil'";
...
if (mysqli_num_rows($result) == 0) {
    echo "<p>No faculty data found for the CIVIL department.</p>";
}
?>
...
<head>
    ...
    <title>HOD Dashboard - CIVIL Faculty</title>
    <style>
        /* General Styling */
        body {
...
<body>
    ...
    <h2>CIVIL Department Faculty Details</h2>
    ...
    <a href="CVILhod.php" class="back-link">Back to Dashboard</a>
