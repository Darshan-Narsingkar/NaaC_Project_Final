...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM  research_papers WHERE status='1' AND department = ?";
    ...
    $sql = "SELECT * FROM  research_papers WHERE status='1'";
...
<head>
    ...
    <title> research_papers - Principal Dashboard</title>
    <!-- Bootstrap CSS -->
...
<div class="container my-4">
    <h2 class="text-center mb-4">All  research_papers Signed During the Year</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="principleresearch_papers.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
           ...
           <button class="btn btn-secondary" onclick="window.open('analysis/Print_principal_paper.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('analysis/paperexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('analysis/paperAnalysis.php', '_blank')">View Analysis</button>
