...
$query = "SELECT department, status, COUNT(*) as count FROM industry_academia GROUP BY department, status";
...
<body>
    <h2>industry_academia by Department</h2>
