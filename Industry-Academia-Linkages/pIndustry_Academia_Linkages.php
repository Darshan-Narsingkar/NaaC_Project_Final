...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM industry_academia
...
<div class="container">
    <h2 class="text-center mb-4">industry_academia
 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="Industry-Academia-Linkages/pIndustry_Academia_Linkages.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['industry_name']); ?></td>
                            <td><?php echo htmlspecialchars($record['collaboration_type']); ?></td>
                            <td><?php echo htmlspecialchars($record['beneficiaries']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('Industry-Academia-Linkages/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('Industry-Academia-Linkages/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Industry-Academia-Linkages/Analysis.php', '_blank')">View Analysis</button>
