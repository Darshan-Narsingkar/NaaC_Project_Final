...
<div class="container mt-5">
        <h2 class="text-center">Industry-Academia Linkages</h2>
        <form action="Industry-Academia-Linkages/submit_industry_academia.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
