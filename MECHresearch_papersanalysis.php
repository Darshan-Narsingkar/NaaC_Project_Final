...
<body>
    <h2>Research Papers Analysis - Mechanical Department</h2>
    ...
    <?php if (!empty($data)) { ?>
        ...
        <?php } ?>
    <?php } else { ?>
        <p>No data available for research papers.</p>
    <?php } ?>
        ...
        ?>
            ...
            new Chart(ctxBar, {
                ...
                data: {
                    labels: labels,
                    datasets: [{
                        label: '<?php echo htmlspecialchars($department); ?> Research Papers Count',
                        data: counts,
            ...
            new Chart(ctxPie, {
                ...
                data: {
                    labels: labels,
                    datasets: [{
                        label: '<?php echo htmlspecialchars($department); ?> Research Papers Distribution',
                        data: counts,
