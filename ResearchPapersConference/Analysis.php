...
$query = "SELECT department, status, COUNT(*) as count FROM conference_papers GROUP BY department, status";
...
<body>
    <h2>conference_papers by Department</h2>
