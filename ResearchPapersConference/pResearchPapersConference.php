...
<div class="container">
    <h2 class="text-center mb-4">conference_papers

 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="ResearchPapersConference/pResearchPapersConference.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['proceedings_title']); ?></td>
                            <td><?php echo htmlspecialchars($record['conference_name']); ?></td>
                            <td><?php echo htmlspecialchars($record['conference_type']); ?></td>
                            <td><?php echo htmlspecialchars($record['isbn_issn']); ?></td>
                            <td><?php echo htmlspecialchars($record['publisher']); ?></td>
                            <td><?php echo htmlspecialchars($record['affiliating_institute']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('ResearchPapersConference/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('ResearchPapersConference/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('ResearchPapersConference/Analysis.php', '_blank')">View Analysis</button>
