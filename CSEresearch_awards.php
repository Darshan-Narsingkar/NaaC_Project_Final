...
<h2>research_awards Records (CSE Department)</h2>

<!-- Search Form -->
<form method="post" action="CSEresearch_awards.php">
        ...
        <tr class="<?= $status_class; ?>">
            ...
            <td>
                <?php if ($row['status'] == '0' || $row['status'] == '2') { ?>
                    <a href="CSEresearch_awards.php?accept_id=<?= $row['id']; ?>" class="accept-btn">Accept</a>
                <?php } ?>

                <?php if ($row['status'] == '0' || $row['status'] == '1') { ?>
                    <a href="CSEresearch_awards.php?reject_id=<?= $row['id']; ?>" class="reject-btn">Reject</a>
                <?php } ?>
...
<!-- Action Buttons -->
<button onclick="window.open('CSEprint_research_award.php', '_blank')" class="action-btn print-btn">Print</button>
<button class="btn btn-danger print-btn action-btn" onclick="window.open('CSEresearch_award_to_pdf.php', '_blank')">Export to PDF</button>
<button class="btn btn-danger print-btn action-btn" onclick="window.open('CSEresearch_awardanalysis.php', '_blank')">View Analysis</button>

<!-- Pagination -->
<div style="text-align:center; margin-top:20px;">
    <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
        <a href="CSEresearch_awards.phpp?page=<?= $i; ?>" style="margin: 5px;"><?= $i; ?></a>
    <?php } ?>
