...
$query = "SELECT department, status, COUNT(*) as count FROM book_chapter_publications WHERE department='mech' GROUP BY department, status";
...
<body>
    <h2>Book Chapter Publications Analysis (MECH Department)</h2>
    ...
    <?php } 
        ...
        <p>No data found for mech Department.</p>
    <?php } ?>
