...
$query = "SELECT department, status, COUNT(*) as count FROM book_chapter_publications WHERE department='extc' GROUP BY department, status";
...
<body>
    <h2>Book Chapter Publications Analysis (extc Department)</h2>
    ...
    <?php } 
        ...
        <p>No data found for extc Department.</p>
    <?php } ?>
