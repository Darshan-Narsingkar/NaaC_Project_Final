...
<head>
    ...
    <title>research_papers Records (IT Department)</title>
...
<h2>research_papers Records (IT Department)</h2>
        ...
        <tr class="<?= $status_class; ?>">
            ...
            <td>
                <?php if ($row['status'] == '0' || $row['status'] == '2') { ?>
                    <a href="hresearch_papers.php?accept_id=<?= $row['id']; ?>" class="accept-btn">Accept</a>
                <?php } ?>

                <?php if ($row['status'] == '0' || $row['status'] == '1') { ?>
                    <a href="hresearch_papers.php?reject_id=<?= $row['id']; ?>" class="reject-btn">Reject</a>
                <?php } ?>

                <?php if ($row['status'] != '2') { ?>
                    <a href="Updateresearch_papers.php?id=<?= $row['id']; ?>">
...
<!-- Action Buttons -->
<button onclick="window.open('hprint_research_papers.php', '_blank')" class="action-btn print-btn">Print</button>
<button class="btn btn-danger print-btn action-btn" onclick="window.open('research_paper_to_pdf.php', '_blank')">Export to PDF</button>
<button class="btn btn-danger print-btn action-btn" onclick="window.open('research_papersanalysis.php', '_blank')">View Analysis</button>
