...
<?php
session_start();
if (!isset($_SESSION['user_role']) || $_SESSION['user_role'] !== 'CVILhod') {
...
<body>
    ...
    <h4 class="mb-0">&nbsp;&nbsp;<i class="fas fa-university"></i> <span class="ml-2">&nbsp;&nbsp;SIPNA COLLEGE OF ENGINEERING & TECHNOLOGY, AMRAVATI</span></h4>
        ...
        <span class="user-name">CIVIL(Head Of Department)</span>
    ...
    function loadresearch_papers() {
        fetch('CIVILresearch_papers.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadChaptersPublished() {
        fetch('CIVILbook_chapter_publications.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadResearchAwards() {
        fetch('CIVILresearch_awards.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
