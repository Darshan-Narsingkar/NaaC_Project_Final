...
<div class="container mt-5">
        <h2 class="text-center">No of Extension & Outreach Programs</h2>
        <form action="Extension/submit_extension_outreach.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="date_conducted" required>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" name="key_outcomes" rows="1" required></textarea>
                    </div>
