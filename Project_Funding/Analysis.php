...
$query = "SELECT department, status, COUNT(*) as count FROM project_funding GROUP BY department, status";
...
<head>
    ...
    <title>project_funding Analysis</title>
...
<body>
    <h2>project_funding Analysis by Department</h2>
    ...
    ?>
        ...
        new Chart(ctxBar, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> project_funding Count',
                    data: counts,
        ...
        new Chart(ctxPie, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> project_funding Distribution',
                    data: counts,
