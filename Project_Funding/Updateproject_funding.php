...
$id = $project_nature = $duration = $funding_agency = $total_grant = $amount_received = $proof_file = "";
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    // Fetch existing data
    $query = "SELECT * FROM project_funding WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update query
    $updateQuery = "UPDATE project_funding SET project_nature = ?, duration = ?, funding_agency = ?, total_grant = ?, amount_received = ?, proof_file = ? WHERE id = ?";
    ...
    $stmt->bind_param("ssssssi", $project_nature, $duration, $funding_agency, $total_grant, $amount_received, $proof_file, $id);
        ...
        <table border="1">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="project_nature" value="<?= htmlspecialchars($project_nature) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                    <td><input type="text" name="duration" value="<?= htmlspecialchars($duration) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                    ...
                    <td><input type="text" name="total_grant" value="<?= htmlspecialchars($total_grant) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                    <td><input type="text" name="amount_received" value="<?= htmlspecialchars($amount_received) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                    <td>
