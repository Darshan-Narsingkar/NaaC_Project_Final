...
<div class="container mt-5">
    <h2 class="text-center">Faculty Research Projects</h2>
    
    <form action="Project_Funding/Project_Funding_Form_submit.php" method="POST" enctype="multipart/form-data" class="p-4 border rounded bg-light">
        <div class="row">
            <!-- Nature of the Project -->
            <div class="col-md-6 mb-3">
                <label class="form-label">Nature of the Project</label>
                <input type="text" class="form-control" name="project_nature" placeholder="Enter project nature" required>
            </div>
        ...
        <div class="row">
            <!-- Funding Agency -->
            <div class="col-md-6 mb-3">
                <label class="form-label">Name of the Funding Agency</label>
                <input type="text" class="form-control" name="funding_agency" placeholder="Enter funding agency name" required>
            </div>

            <!-- Total Grant Sanctioned -->
            <div class="col-md-6 mb-3">
                <label class="form-label">Total Grant Sanctioned (₹)</label>
                <input type="number" class="form-control" name="total_grant" placeholder="Enter sanctioned amount" required>
            </div>
        </div>
        ...
        <div class="row">
            <!-- Amount Received -->
            <div class="col-md-6 mb-3">
                <label class="form-label">Amount Received During the Year (₹)</label>
                <input type="number" class="form-control" name="amount_received" placeholder="Enter received amount" required>
            </div>
