...
<div class="container">
    <h2 class="text-center mb-4">All MoUs Signed During the Year</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="principalmou.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
           ...
           <button class="btn btn-secondary" onclick="window.open('Print_principal__mous.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('export_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Analysis.php', '_blank')">View Analysis</button>
