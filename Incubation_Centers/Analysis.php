...
$query = "SELECT department, status, COUNT(*) as count FROM incubation_centers GROUP BY department, status";
...
<head>
    ...
    <title>incubation_centers</title>
...
<body>
    <h2>incubation_centers by Department</h2>
