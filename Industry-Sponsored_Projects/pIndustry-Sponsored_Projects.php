...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM industry_projects
...
<div class="container">
    <h2 class="text-center mb-4">industry_projects
 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="Industry-Sponsored_Projects/pIndustry-Sponsored_Projects.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['industry_partner']); ?></td>
                            <td><?php echo htmlspecialchars($record['industry_type']); ?></td>
                            <td><?php echo htmlspecialchars($record['funding_amount']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('Industry-Sponsored_Projects/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('Industry-Sponsored_Projects/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Industry-Sponsored_Projects/Analysis.php', '_blank')">View Analysis</button>
