...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Industry-Sponsored Projects</h2>
        <form action="Industry-Sponsored_Projects/submit_industry_projects.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Industry Partner Name:</label>
                    <input type="text" class="form-control" name="industry_partner" required>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Funding Amount (INR/USD):</label>
                    <input type="number" class="form-control" name="funding_amount" required>
                </div>
                <div class="col-md-6 mb-3">
