...
$query = "SELECT department, status, COUNT(*) as count FROM industry_projects GROUP BY department, status";
...
<body>
    <h2>industry_projects by Department</h2>
