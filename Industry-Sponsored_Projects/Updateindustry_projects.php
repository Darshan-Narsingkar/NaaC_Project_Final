...
$id = $project_title = $industry_partner = $industry_type = $funding_amount = $proof_file = "";
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    // Fetch existing data
    $query = "SELECT * FROM industry_projects WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update query
    $updateQuery = "UPDATE industry_projects SET project_title = ?, industry_partner = ?, industry_type = ?, funding_amount = ?, proof_file = ? WHERE id = ?";
    ...
    $stmt->bind_param("ssssss", $project_title, $industry_partner, $industry_type, $funding_amount, $proof_file, $id);
        ...
        <table border="1">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="industry_partner" value="<?= htmlspecialchars($industry_partner) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                    <td><input type="text" name="industry_type" value="<?= htmlspecialchars($industry_type) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                    <td><input type="text" name="funding_amount" value="<?= htmlspecialchars($funding_amount) ?>" required required style="border: none; outline: none; background: transparent;"></td>
                     <td>
