...
$query = "SELECT department, status, COUNT(*) as count FROM book_chapter_publications WHERE department='cse' GROUP BY department, status";
...
<body>
    <h2>Book Chapter Publications Analysis (CSE Department)</h2>
