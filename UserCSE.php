...
if (mysqli_num_rows($result) == 0) {
    echo "<p>No faculty data found for the CSE department.</p>";
}
?>
...
<head>
    ...
    <title>HOD Dashboard - CSE Faculty</title>
    <style>
        /* General Styling */
        body {
...
<body>
    ...
    <h2>CSE Department Faculty Details</h2>
    ...
    <a href="CSEhod.php" class="back-link">Back to Dashboard</a>
