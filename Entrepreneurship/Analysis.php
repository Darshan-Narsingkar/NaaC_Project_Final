...
$query = "SELECT department, status, COUNT(*) as count FROM entrepreneurship_programs GROUP BY department, status";
...
<head>
    ...
    <title>entrepreneurship_programsAnalysis</title>
...
<body>
    <h2>entrepreneurship_programsAnalysis by Department</h2>
