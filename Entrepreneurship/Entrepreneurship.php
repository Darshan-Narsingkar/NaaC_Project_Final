...
<div class="container mt-5">
        <h2 class="text-center">Entrepreneurship Development Programs</h2>
        <form action="Entrepreneurship/submit_entrepreneurship.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" name="key_outcomes" rows="3" required>
                </div>
                <div class="col-md-6 mb-3">
