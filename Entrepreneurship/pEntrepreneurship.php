...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM entrepreneurship_programs
...
<div class="container">
    <h2 class="text-center mb-4">entrepreneurship_programs

 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="Entrepreneurship/pEntrepreneurship.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
           ...
           <button class="btn btn-secondary" onclick="window.open('Entrepreneurship/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('Entrepreneurship/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Entrepreneurship/Analysis.php', '_blank')">View Analysis</button>
