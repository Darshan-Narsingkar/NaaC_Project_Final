...
$query = "SELECT department, status, COUNT(*) as count FROM mou_institutions GROUP BY department, status";
...
<body>
    <h2>mou_institutions by Department</h2>
