...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM mou_institutions
...
<div class="container">
    <h2 class="text-center mb-4">mou_institutions

 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="Institutionsmous/pInstitutionsmous.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['mou_signed_date']); ?></td>
                            <td><?php echo htmlspecialchars($record['mou_purpose']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('Institutionsmous/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('Institutionsmous/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Institutionsmous/Analysis.php', '_blank')">View Analysis</button>
