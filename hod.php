...
<body>
    ...
    <h4 class="mb-0">&nbsp;&nbsp;<i class="fas fa-university"></i> <span class="ml-2">&nbsp;&nbsp;SIPNA COLLEGE OF ENGINEERING & TECHNOLOGY, AMRAVATI</span></h4>
        ...
        <span class="user-name">IT(Head Of Department)</span>
...
function loadContentFacultyResearchProjects() {
        fetch("Faculty_Research_Projects/hFaculty_Research_Projects.php")
...
function loadContentIndustrySponsoredProjects() {
        fetch("Industry-Sponsored_Projects/hIndustry-Sponsored_Projects.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentIncubationCenters() {
        fetch("Incubation_Centers/hIncubation_Centers.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentInnovationandStartups() {
        fetch("Innovation_Startups/hInnovation_and_Start-ups.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentEntrepreneurshipDevelopmentPrograms() {
        fetch("Entrepreneurship/hEntrepreneurship.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadMoUsWithInstitutions() {
        fetch("Institutionsmous/hInstitutionsmous.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadIndustryAcdemiaLinkages() {
        fetch("Industry-Academia-Linkages/hIndustry_Academia_Linkages.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentExtensionandOutreachProgram() {
        fetch("Extension/hExtension.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentAwardsRecognitionReceived() {
        fetch("Recognition_Received/hRecognition_Received.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentCollaborationsNGOs() {
        fetch("CollaborationsNGO/hCollaborationsNGO.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function  loadResearchPapersConference() {
        fetch('ResearchPapersConference/hResearchPapersConference.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadUser() {
    ...
    function loadChaptersPublished() {
        fetch('hbook_chapter_publications.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadContentResearchFundingandGrants() {
        fetch('Project_Funding/hProject_Funding.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
