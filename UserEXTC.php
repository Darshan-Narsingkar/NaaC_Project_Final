...
$query = "SELECT * FROM faculty WHERE department = 'extc'";
...
if (mysqli_num_rows($result) == 0) {
    echo "<p>No faculty data found for the EXTC department.</p>";
}
?>
...
<head>
    ...
    <title>HOD Dashboard - EXTC Faculty</title>
    <style>
        /* General Styling */
        body {
...
<body>
    ...
    <h2>EXTC Department Faculty Details</h2>
    ...
    <a href="EXTChod.php" class="back-link">Back to Dashboard</a>
