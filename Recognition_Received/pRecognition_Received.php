...
<div class="container">
    <h2 class="text-center mb-4">awards

 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="Recognition_Received/pRecognition_Received.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['issuing_organization']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('Recognition_Received/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('Recognition_Received/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Recognition_Received/Analysis.php', '_blank')">View Analysis</button>
