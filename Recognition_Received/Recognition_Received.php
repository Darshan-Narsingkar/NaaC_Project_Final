...
<div class="container mt-5">
        <h2 class="text-center">Awards & Recognition Received</h2>
        <form action="Recognition_Received/submit_awards.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
