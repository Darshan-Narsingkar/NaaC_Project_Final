...
if (mysqli_num_rows($result) == 0) {
    echo "<p>No faculty data found for the IT department.</p>";
}
?>
...
<head>
    ...
    <title>HOD Dashboard - IT Faculty</title>
    <style>
        /* General Styling */
        body {
...
<body>
    ...
    <h2>IT Department Faculty Details</h2>
    ...
    <a href="hod.php" class="back-link">Back to Dashboard</a>
