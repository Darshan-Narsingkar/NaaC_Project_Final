...
<?php
session_start();
if (!isset($_SESSION['user_role']) || $_SESSION['user_role'] !== 'MECHhod') {
...
<body>
    ...
    <h4 class="mb-0">&nbsp;&nbsp;<i class="fas fa-university"></i> <span class="ml-2">&nbsp;&nbsp;SIPNA COLLEGE OF ENGINEERING & TECHNOLOGY, AMRAVATI</span></h4>
        ...
        <span class="user-name">MECH(Head Of Department)</span>
...
function loadUser() {
    ...
    function loadChaptersPublished() {
        fetch('MECHbook_chapter_publications.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
