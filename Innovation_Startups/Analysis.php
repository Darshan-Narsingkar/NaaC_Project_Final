...
$query = "SELECT department, status, COUNT(*) as count FROM innovation_startups GROUP BY department, status";
...
<head>
    ...
    <title>innovation_startups</title>
...
<body>
    <h2>innovation_startups by Department</h2>
