...
<div class="container mt-5">
        <h2 class="text-center">Innovation and Start-ups</h2>
        <form action="Innovation_Startups/submit_innovation_startups.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Founder(s):</label>
                    <input type="text" class="form-control" name="founders" required>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Industry Collaborations:</label>
                    <input class="form-control" name="industry_collaborations" rows="3">
                </div>
                <div class="col-md-6 mb-3">
