...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM innovation_startups
...
<div class="container">
    <h2 class="text-center mb-4">innovation_startups

 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="Innovation_Startups/pInnovation_and_Start-ups.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['startup_name']); ?></td>
                            <td><?php echo htmlspecialchars($record['founders']); ?></td>
                            <td><?php echo htmlspecialchars($record['funding_received']); ?></td>
                            <td><?php echo htmlspecialchars($record['industry_collaborations']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('Innovation_Startups/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('Innovation_Startups/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('Innovation_Startups/Analysis.php', '_blank')">View Analysis</button>
