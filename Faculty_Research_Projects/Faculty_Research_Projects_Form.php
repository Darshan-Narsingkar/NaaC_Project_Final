...
<head>
    ...
    <div class="container mt-5">
        ...
        <form action="Faculty_Research_Projects\submit_faculty_projects.php" method="post" class="p-4 border rounded bg-light" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="pi_name" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Co-Investigators (if any):</label>
                    <input type="text" class="form-control" name="co_investigators">
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Funding Agency Name:</label>
                    <input type="text" class="form-control" name="funding_agency" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Grant Amount (INR/USD):</label>
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">Research Objectives:</label>
                    <textarea class="form-control" name="research_objectives" rows="1" required></textarea>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Research Outcomes:</label>
                    <textarea class="form-control" name="research_outcomes" rows="1"></textarea>
                </div>
                <div class="col-md-6 mb-3">
