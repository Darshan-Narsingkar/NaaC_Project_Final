...
$query = "SELECT department, status, COUNT(*) as count FROM faculty_projects GROUP BY department, status";
...
<body>
    <h2>faculty_projects by Department</h2>
