...
$query = "SELECT department, status, COUNT(*) as count FROM ngos_collaborations GROUP BY department, status";
...
<head>
    ...
    <title>ngos_collaborationsAnalysis</title>
...
<body>
    <h2>ngos_collaborationsAnalysis by Department</h2>
    ...
    ?>
        ...
        new Chart(ctxBar, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> ngos_collaborationsCount',
                    data: counts,
        ...
        new Chart(ctxPie, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo $department; ?> ngos_collaborationsDistribution',
                    data: counts,
