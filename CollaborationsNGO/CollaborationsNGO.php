...
<div class="container mt-5">
        <h2 class="text-center">Collaborations with NGOs</h2>
        <form action="CollaborationsNGO/submit_ngos.php" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">NGO Name:</label>
                    <input type="text" class="form-control" name="ngo_name" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Type of Collaboration:</label>
                    <input type="text" class="form-control" name="collaboration_type" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Number of Beneficiaries:</label>
                    <input type="number" class="form-control" name="beneficiaries" required>
                </div>
                <div class="col-md-6 mb-3">
