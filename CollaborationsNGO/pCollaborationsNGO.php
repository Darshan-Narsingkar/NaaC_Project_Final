...
if (!empty($selectedDepartment)) {
    ...
    $sql = "SELECT * FROM ngos_collaborations
...
<div class="container">
    <h2 class="text-center mb-4">ngos_collaborations

 Records</h2>

    <!-- Department Dropdown -->
    <form method="GET" action="CollaborationsNGO/pCollaborationsNGO.php" class="mb-3">
    ...
    <?php else: ?>
        <div class="table-responsive">
                ...
                <tbody>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['ngo_name']); ?></td>
           ...
           <button class="btn btn-secondary" onclick="window.open('CollaborationsNGO/Print_principal.php', '_blank')">Print</button>
            <button class="btn btn-success" onclick="window.open('CollaborationsNGO/principalexport_to_pdf.php', '_blank')">Export to PDF</button>
            <button class="btn btn-danger print-btn action-btn" onclick="window.open('CollaborationsNGO/', '_blank')">View Analysis</button>

    <?php endif; ?>
</div>


<div class="text-center mt-3">Analysis.php
