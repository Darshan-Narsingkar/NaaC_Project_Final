...
.sidebar::-webkit-scrollbar-track {
    background-color: rgba(255, 255, 255, 0.2); /* Scrollbar track */
}
        ...
        <div class="dropdown">
            ...
            <div id="criteria3" class="dropdown-content">
                ...
                <div id="criteria3_4" class="dropdown-content">
                    ...
                    <a onclick="loadContentCollaborationsNGOs()">- Collaborations with NGOs</a>
                </div>
     ...
     <h4 class="mb-0">&nbsp;&nbsp;<i class="fas fa-university"></i> <span class="ml-2">&nbsp;&nbsp;SIPNA COLLEGE OF ENGINEERING & TECHNOLOGY, AMRAVATI</span></h4>
        ...
        <div class="user-dropdown">
            <button id="userDropdownButton">
                ...
                <span class="user-name">Principle</span>
...
function loadContentFacultyResearchProjects() {
        fetch("Faculty_Research_Projects/pFaculty_Research_Projects.php")
...
function loadContentIndustrySponsoredProjects() {
        fetch("Industry-Sponsored_Projects/pIndustry-Sponsored_Projects.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentIncubationCenters() {
        fetch("Incubation_Centers/pIncubation_Centers.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentInnovationandStartups() {
        fetch("Innovation_Startups/pInnovation_and_Start-ups.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentEntrepreneurshipDevelopmentPrograms() {
        fetch("Entrepreneurship/pEntrepreneurship.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadMoUsWithInstitutions() {
        fetch("Institutionsmous/pInstitutionsmous.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadIndustryAcdemiaLinkages() {
        fetch("Industry-Academia-Linkages/pIndustry_Academia_Linkages.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentExtensionandOutreachProgram() {
        fetch("Extension/pExtension.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentAwardsRecognitionReceived() {
        fetch("Recognition_Received/pRecognition_Received.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function loadContentCollaborationsNGOs() {
        fetch("CollaborationsNGO/pCollaborationsNGO.php")
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
...
function  loadResearchPapersConference() {
        fetch('ResearchPapersConference/pResearchPapersConference.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadContentResearchFundingandGrants() {
        fetch('Project_Funding/pProject_Funding.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadChaptersPublished() {
        fetch('principalbook_chapter_publications.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadresearch_papers() {
        fetch('principleresearch_papers.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
    ...
    function loadResearchAwards() {
        fetch('principalresearch_awards.php')
            .then(response => response.text())
            .then(data => {
                document.getElementById('mainContent').innerHTML = data;
            })
