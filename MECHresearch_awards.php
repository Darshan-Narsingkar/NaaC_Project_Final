...
<!-- Search Form -->
<form method="post" action="MECHresearch_awards.php">
...
<!-- Action Buttons -->
<button onclick="window.open('MECHprint_research_award.php', '_blank')" class="action-btn print-btn">Print</button>
<button class="btn btn-danger print-btn action-btn" onclick="window.open('MECHresearch_award_to_pdf.php', '_blank')">Export to PDF</button>
<button class="btn btn-danger print-btn action-btn" onclick="window.open('MECHresearch_awardanalysis.php', '_blank')">View Analysis</button>
